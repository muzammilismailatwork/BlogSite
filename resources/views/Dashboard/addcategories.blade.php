            ...
            <div class="card mb-4 p-3">
                ...
                <div class="card-body px-0 pt-0 pb-2">
                    <div class="table-responsive p-0">
                        <form method="POST" action="{{route("dashboard.category.store")}}" class="align-items-center mb-0" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="form-group">
                                ...
                                <input name="image" type="file" class="form-control" id="exampleInputPassword1" placeholder="Choose File">
                            </div>
                            @error("image")
                            {{$message}}
                            @enderror
